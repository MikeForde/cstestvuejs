  ...
  <div>
    ...
    <section class="info-section" ref="section1" :data-section="1" :class="{ 'fade-in': showSection1 }">
      <div class="info-card">
        ...
        <p><i>* I do not charge for therapy but ask my clients to contribute towards room hire - <router-link to="/business" class="button-link">please see fees</router-link></i></p>
    ...
    <section class="info-section" ref="section2" :data-section="2" :class="{ 'fade-in': showSection2 }">
      <div class="info-card">
        ...
        <p>The Clear Skies Practice is located on the 1st floor in the Devereux Centre, Tewkesbury. The Centre is well situated and easy walking distance from the High Street.</p>
