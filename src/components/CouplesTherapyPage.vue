  ...
  <div>
    ...
    <section class="content-section blackWhite" ref="section1" :data-section="1" :class="{ 'fade-in': showSection1 }">
      <div class="card-row">
        ...
        <div class="card text-card">
          ...
          <p>
            Relationships can be deeply meaningful—and deeply challenging. Whether you’re feeling disconnected, stuck in conflict,
            or struggling to rebuild trust, couples therapy can help you understand each other more clearly and reconnect in a healthier way.
          </p>
          <p>
            As a HG psychotherapist I work within the framework of essential human needs as a foundation for supporting individual wellbeing
            and thriving relationships. My couples therapy work also incorporates practical communication and conflict resolution skills
    ...
    <section class="content-section whiteBlue" ref="section2" :data-section="2" :class="{ 'fade-in': showSection2 }">
      <div class="card-row">
        ...
        <div class="card image-card">
          <img src="@/assets/Spinning couple.jpg" alt="Spinning couple" class="section-image focus-top" loading="lazy" />
        </div>
      </div>
    </section>
    ...
    <section class="content-section blackWhite" ref="section3" :data-section="3" :class="{ 'fade-in': showSection3 }">
      <div class="card-row">
        ...
        <div class="card text-card">
          ...
          <p>
            Therapy is goal-oriented but flexible. Some couples come for <strong>short-term support</strong>, while others choose
            <strong>longer-term work</strong>.
            <em>You don’t need to be “in crisis” to benefit from couples therapy—many couples come to strengthen an already meaningful relationship.</em>
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="content-section whiteBlue" ref="section4" :data-section="4" :class="{ 'fade-in': showSection4 }">
      <div class="card-row">
        <div class="card text-card">
          <h2>Why individual sessions may be included</h2>
          <p>While most couples therapy sessions are attended together, there are times when <strong>individual sessions</strong> can be a helpful and appropriate part of the process.</p>
          <p>These sessions are always used <strong>in service of the relationship</strong>, not instead of couples work.</p>
          <p>Individual sessions help each partner gain <strong>insight into their own patterns, emotions, and stress responses</strong>, which often makes joint sessions more productive and less reactive.</p>
        </div>
    ...
    <section class="content-section blackWhite" ref="section5" :data-section="5" :class="{ 'fade-in': showSection5 }">
      <div class="card-row single">
        <div class="card text-card">
          ...
          <p>Individual sessions are confidential. They are used to support the couples therapy and the relationship as a whole, not to take sides or keep harmful secrets.</p>
          <p>If something important for the relationship comes up, we will discuss together how it can be shared in a safe and respectful way.</p>
          <p>As with all therapy, confidentiality may only be broken in rare situations required by law or professional ethics, such as concerns about safety.</p>
        </div>
      </div>
    </section>
  </div>
...
@media screen and (max-width: 768px) {
  ...
  .text-card {
    width: 100%;
    padding: 16px 20px 0;   /* top padding gives the “breathing space” */
    box-sizing: border-box;
  }
